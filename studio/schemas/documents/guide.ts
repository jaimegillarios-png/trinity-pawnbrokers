...
export const guide = defineType({
  ...
  fields: [
    ...
    defineField({ name: 'closing', type: 'text', rows: 4, group: 'content', description: 'The last paragraph, just above the button.' }),
    defineField({
      name: 'cta',
      title: 'Button at the foot',
      type: 'object',
      group: 'content',
      description: 'The only call to action on the page.',
      fields: [
        defineField({ name: 'label', type: 'string' }),
