...
export default {
  ...
  meta: {
    ...
    description: 'TODO — one-sentence description for search results, mentioning fine art, £500 minimum and the City of London.',
  },

  hero: {
    image: { src: 'images/v2/art.jpg', alt: 'TODO — describe the work image' },
    eyebrow: 'Pawnbroker loans against fine art · City of London · Est. 2013',
  ...
  form: {
    ...
    // TODO — replace with the fields that actually matter for fine art.
    fields: [
      [
  ...
  lendAgainst: {
    ...
    heading: 'The fine art we lend against',
  ...
  borrow: {
    ...
    intro: 'TODO — how fine art are valued, and why that beats the high street.',
    specs: [
    ...
    example: {
      ...
      statement: 'TODO — a £X,XXX loan against a specific work, over 6 months',
      rows: [
      ...
      note: 'Illustrative only. Your own figures depend on the specific work, its condition, and the market on the day — you see them in full before you commit to anything.',
    },
  },

  how: {
    eyebrow: 'How it works',
    heading: 'TODO — four steps, ending with the work back with you.',
    steps: [
      { icon: 'ph-chat-teardrop-text', title: 'Tell us about your work', body: 'TODO' },
  ...
  why: {
    ...
    heading: 'A pawnbroker for fine art you intend to <span>keep</span>.',
    intro: 'TODO — we lend against it, we do not buy it.',
    rows: [
      { icon: 'ph-diamond', label: 'Your work', trinity: 'Yours throughout — a loan, never a sale', highStreet: 'Often bought outright' },
  ...
  faqs: {
    ...
    items: [
      { q: 'Do I have to sell my work?', a: 'No. This is a loan against it. You keep ownership throughout and take it back when you repay.' },
      { q: 'TODO — an objection specific to fine art', a: 'TODO' },
  ...
  closing: {
    eyebrow: 'Get started',
    heading: 'Find out what your work is worth',
  ...
  specimenBar: 'Asset template · Fine art instance · PLACEHOLDER COPY — not for review',
};
