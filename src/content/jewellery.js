...
export default {
  ...
  meta: {
    ...
    description: 'TODO — one-sentence description for search results, mentioning jewellery, £500 minimum and the City of London.',
  },

  hero: {
    image: { src: 'images/v2/jewellery.jpg', alt: 'TODO — describe the piece image' },
  ...
  form: {
    ...
    // TODO — replace with the fields that actually matter for jewellery.
    fields: [
      [
  ...
  borrow: {
    ...
    intro: 'TODO — how jewellery are valued, and why that beats the high street.',
    specs: [
  ...
  faqs: {
    ...
    items: [
      ...
      { q: 'TODO — an objection specific to jewellery', a: 'TODO' },
  ...
  specimenBar: 'Asset template · Jewellery instance · PLACEHOLDER COPY — not for review',
};
