...
export default {
  ...
  meta: {
    ...
    description: 'TODO — one-sentence description for search results, mentioning designer handbags, £500 minimum and the City of London.',
  },

  hero: {
    image: { src: 'images/v2/bags.jpg', alt: 'TODO — describe the handbag image' },
  ...
  form: {
    ...
    // TODO — replace with the fields that actually matter for designer handbags.
    fields: [
      [
  ...
  lendAgainst: {
    ...
    heading: 'The designer handbags we lend against',
  ...
  borrow: {
    ...
    intro: 'TODO — how designer handbags are valued, and why that beats the high street.',
    specs: [
    ...
    example: {
      ...
      statement: 'TODO — a £X,XXX loan against a specific handbag, over 6 months',
      rows: [
      ...
      note: 'Illustrative only. Your own figures depend on the specific handbag, its condition, and the market on the day — you see them in full before you commit to anything.',
    },
  },

  how: {
    eyebrow: 'How it works',
    heading: 'TODO — four steps, ending with the handbag back with you.',
    steps: [
      { icon: 'ph-chat-teardrop-text', title: 'Tell us about your handbag', body: 'TODO' },
  ...
  why: {
    ...
    heading: 'A pawnbroker for designer handbags you intend to <span>keep</span>.',
    intro: 'TODO — we lend against it, we do not buy it.',
    rows: [
      { icon: 'ph-diamond', label: 'Your handbag', trinity: 'Yours throughout — a loan, never a sale', highStreet: 'Often bought outright' },
  ...
  faqs: {
    eyebrow: 'Designer handbags FAQs',
    heading: 'Asked, answered',
    items: [
      { q: 'Do I have to sell my handbag?', a: 'No. This is a loan against it. You keep ownership throughout and take it back when you repay.' },
      { q: 'TODO — an objection specific to designer handbags', a: 'TODO' },
  ...
  specimenBar: 'Asset template · Designer handbags instance · PLACEHOLDER COPY — not for review',
};
