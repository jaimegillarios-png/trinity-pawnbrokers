...
export default {
  ...
  meta: {
    ...
    description: 'TODO — one-sentence description for search results, mentioning diamonds, £500 minimum and the City of London.',
  },

  hero: {
    image: { src: 'images/v2/diamonds.jpg', alt: 'TODO — describe the diamond image' },
    eyebrow: 'Pawnbroker loans against diamonds · City of London · Est. 2013',
  ...
  form: {
    ...
    // TODO — replace with the fields that actually matter for diamonds.
    fields: [
      [
  ...
  borrow: {
    ...
    intro: 'TODO — how diamonds are valued, and why that beats the high street.',
    specs: [
    ...
    example: {
      ...
      statement: 'TODO — a £X,XXX loan against a specific diamond, over 6 months',
      rows: [
      ...
      note: 'Illustrative only. Your own figures depend on the specific diamond, its condition, and the market on the day — you see them in full before you commit to anything.',
    },
  },

  how: {
    eyebrow: 'How it works',
    heading: 'TODO — four steps, ending with the diamond back with you.',
    steps: [
      { icon: 'ph-chat-teardrop-text', title: 'Tell us about your diamond', body: 'TODO' },
  ...
  why: {
    ...
    rows: [
      { icon: 'ph-diamond', label: 'Your diamond', trinity: 'Yours throughout — a loan, never a sale', highStreet: 'Often bought outright' },
  ...
  faqs: {
    eyebrow: 'Diamonds FAQs',
    heading: 'Asked, answered',
    items: [
      { q: 'Do I have to sell my diamond?', a: 'No. This is a loan against it. You keep ownership throughout and take it back when you repay.' },
      { q: 'TODO — an objection specific to diamonds', a: 'TODO' },
  ...
  specimenBar: 'Asset template · Diamonds instance · PLACEHOLDER COPY — not for review',
};
