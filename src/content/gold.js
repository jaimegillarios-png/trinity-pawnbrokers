...
export default {
  ...
  meta: {
    ...
    description: 'TODO — one-sentence description for search results, mentioning gold, £500 minimum and the City of London.',
  },

  hero: {
    image: { src: 'images/v2/gold.jpg', alt: 'TODO — describe the gold item image' },
  ...
  form: {
    ...
    // TODO — replace with the fields that actually matter for gold.
    fields: [
      [
  ...
  borrow: {
    ...
    intro: 'TODO — how gold are valued, and why that beats the high street.',
    specs: [
    ...
    example: {
      ...
      statement: 'TODO — a £X,XXX loan against a specific gold item, over 6 months',
      rows: [
      ...
      note: 'Illustrative only. Your own figures depend on the specific gold item, its condition, and the market on the day — you see them in full before you commit to anything.',
    },
  },

  how: {
    eyebrow: 'How it works',
    heading: 'TODO — four steps, ending with the gold item back with you.',
    steps: [
      { icon: 'ph-chat-teardrop-text', title: 'Tell us about your gold item', body: 'TODO' },
  ...
  why: {
    ...
    rows: [
      { icon: 'ph-diamond', label: 'Your gold item', trinity: 'Yours throughout — a loan, never a sale', highStreet: 'Often bought outright' },
  ...
  faqs: {
    ...
    items: [
      { q: 'Do I have to sell my gold item?', a: 'No. This is a loan against it. You keep ownership throughout and take it back when you repay.' },
      { q: 'TODO — an objection specific to gold', a: 'TODO' },
  ...
  closing: {
    eyebrow: 'Get started',
    heading: 'Find out what your gold item is worth',
  ...
  specimenBar: 'Asset template · Gold instance · PLACEHOLDER COPY — not for review',
};
