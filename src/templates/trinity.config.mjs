/* Trinity — site-wide constants shared by every generated page.
 * Change the phone number or the legal footer once, here, and rebuild. */
export default {
  name: 'Trinity Pawnbrokers',
  phone: '020 3567 1300',
  phoneHref: '+442035671300',

  ruleBar: {
    left: 'Pawnbrokers · Est. 2013 · City of London',
    right: 'FCA-regulated · Ref 741896',
  },
  ...
  reviewsStore: 'unbolted-financial-services',
};
